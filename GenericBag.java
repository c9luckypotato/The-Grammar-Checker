package proj5;
/**
 * A very reusable Bag class.  Courtesy of Generics!
 * 
...
public class GenericBag<E> {
     ...
     */
    public boolean equals(GenericBag<E> otherBag)
    {
    	if (this.size()!=otherBag.size())
    		return false;
    	else {
    		GenericBag<E> thisCopy = this.clone();
    		GenericBag<E> otherCopy = otherBag.clone();
    ...
    {
    	GenericBag<E> newBag = new GenericBag<E>(this.capacity());
     ...
     */
    public GenericBag<E> union(GenericBag<E> otherBag)
    {
    	GenericBag<E> newBag = this.clone();
    	GenericBag<E> temp = otherBag.clone();
    	while (!temp.isEmpty()) {
